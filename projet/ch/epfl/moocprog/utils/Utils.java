...
public final class Utils {
     ...
     *
     * @param values Les valeurs Ã  considérer
     * @param probs Un tableau représentant la probabilité
     *              associée Ã  chaque valeur du tableau {@code values}
     ...
     * @param condition La condition qui, si évaluée Ã  {@code false}
    ...
    /**
     * Possède le meme comportement que {@link #require(String, boolean)}
     * mais sans message détaillé de l'erreur.
     *
     * @param condition La condition qui, si est évaluée Ã  {@code false}
     *                  provoque l'exception {@code IllegalArgumentException}
     *
    ...
    /**
     * Possède le meme comportement que {@link #requireNonNull(String, Object)}
     * mais sans message détaillé de l'erreur.
     *
     * @param toTest L'objet qui, si vaut {@code null}, provoque
     *               l'exception {@code IllegalArgumentException}
